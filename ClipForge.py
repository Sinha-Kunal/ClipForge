...
class VideoClipMarker:
    ...
    def setup_ui(self):
        ...
        tk.Button(actions_frame, text="💾 Save All Clips & Export CSV", command=self.save_all_clips,
                 font=("Arial", 12, "bold"), bg="#2196F3", fg="white", padx=20, pady=10).pack(pady=5)
        tk.Button(actions_frame, text="🗑️ Delete Selected Clip", command=self.delete_selected_clip,
        ...
        self.speed_label = tk.Label(speed_frame, text="→ 1x", font=("Arial", 10, "bold"), fg="#2196F3")
        ...
        tk.Button(mark_btn_frame, text="⏺ Mark Start", command=self.mark_start,
                 font=("Arial", 10), bg="#FF9800", fg="white", width=15).pack(side=tk.LEFT, padx=5)
        tk.Button(mark_btn_frame, text="⏹ Mark End", command=self.mark_end,
                 font=("Arial", 10), bg="#f44336", fg="white", width=15).pack(side=tk.LEFT, padx=5)
        tk.Button(mark_btn_frame, text="✖ Clear Current", command=self.clear_current,
